...
export const SCHEMES = [
  ...
  },
  {
    ...
    paints: {
      ...
      'kitchen.door': { color: '#ebe8e2', finish: 'plain', rough: 0.55 }, 'kitchen.upper': { color: '#ebe8e2', finish: 'plain', rough: 0.55 }, 'kitchen.top': { color: '#e9e6df', finish: 'plain', rough: 0.3 },
      'appliance': { color: '#262626', finish: 'plain', rough: 0.4 }, 'steel': { color: '#c3c5c7', finish: 'gloss', metal: 0.9, rough: 0.3 },
  ...
  },
  {
    ...
    paints: {
      ...
      'kitchen.door': { color: '#6a6560', finish: 'plain', rough: 0.5 }, 'kitchen.upper': { color: '#e4dfd8', finish: 'plain', rough: 0.5 }, 'kitchen.top': { color: '#3a3734', finish: 'plain', rough: 0.3 },
      'appliance': { color: '#1f1f1f', finish: 'gloss' }, 'steel': { color: '#b4b6b8', finish: 'gloss', metal: 0.9, rough: 0.35 },
      'wardrobe': { color: '#e4dfd8', finish: 'plain', rough: 0.5 }, 'bed.frame': { color: '#6b5142', finish: 'wood' }, 'bed.linen': { color: '#e3ddd3', finish: 'fabric' },
      'study.cabinet': { color: '#e4dfd8', finish: 'plain', rough: 0.5 }, 'study.top': { color: '#3a3734', finish: 'plain', rough: 0.35 }, 'shoe': { color: '#6b5142', finish: 'wood' },
  ...
  },
  {
    ...
    paints: {
      ...
      'kitchen.door': { color: '#e6e0d5', finish: 'plain', rough: 0.55 }, 'kitchen.upper': { color: '#e6e0d5', finish: 'plain', rough: 0.55 }, 'kitchen.top': { color: '#e1d8c9', finish: 'marble' },
      'appliance': { color: '#2b2a28', finish: 'plain', rough: 0.4 }, 'steel': { color: '#b08d57', finish: 'gloss', metal: 0.85, rough: 0.35 },
      'wardrobe': { color: '#e9e3d9', finish: 'plain', rough: 0.55 }, 'bed.frame': { color: '#8f7a60', finish: 'wood' }, 'bed.linen': { color: '#efe9de', finish: 'fabric' },
      'study.cabinet': { color: '#e9e3d9', finish: 'plain', rough: 0.55 }, 'study.top': { color: '#e1d8c9', finish: 'marble' }, 'shoe': { color: '#3a3733', finish: 'plain', rough: 0.5 },
  ...
  ...[
    {
      ...
      kelvin: 2700,
      s: { wall: '#f3f0ea', ceiling: '#f7f5f1', floor: ['#cbb595', 'wood'], foyer: '#8f8b84', balcony: '#b7b3ab',
           bathF: '#c9c4bb', bathW: '#e9e5de', bathC: '#efece7', kDoor: '#f0ede7', kUpper: '#f0ede7', kTop: ['#eae6df', 'marble'],
           black: '#2c2b29', metal: '#b08d57', cab: '#f0ede7', studyTop: ['#eae6df', 'marble'], wood: '#b89a76', linen: '#f3efe8',
    ...
    },
    {
      ...
      kelvin: 2700,
      s: { wall: '#ece2d3', ceiling: '#f2ebe0', floor: ['#cdbfab', 'tile'], floorBed: ['#c9ac86', 'wood'], floorStudy: ['#c9ac86', 'wood'], floorSmall: ['#c9ac86', 'wood'],
           foyer: '#9a8672', balcony: '#b7ab9b', bathF: '#c7b3a0', bathW: '#e3d6c6', bathC: '#ece3d6', kDoor: '#c9a284', kUpper: '#efe6d8', kTop: ['#efe6d8', 'plain'],
           black: '#3a2f29', metal: '#9c7a52', cab: '#efe6d8', studyTop: ['#b8735a', 'plain'], wood: '#b48b66', linen: '#efe5d6',
    ...
    },
    {
      ...
      s: { wall: '#d3d6c9', ceiling: '#eeeee8', floor: ['#cbb897', 'wood'], foyer: '#87857c', balcony: '#b3b2aa',
           bathF: '#b9bab2', bathW: '#dcded5', bathC: '#e8e9e3', kDoor: '#8a9a86', kUpper: '#eeeae0', kTop: ['#e9e5dc', 'plain'],
           black: '#2e2f2b', metal: '#b08d57', cab: '#eeeae0', studyTop: ['#8a9a86', 'plain'], wood: '#b2966f', linen: '#f0ede4',
    ...
    },
    {
      ...
      kelvin: 2700,
      s: { wall: '#dcd6cc', ceiling: '#e9e5de', floor: ['#7a5c45', 'wood'], foyer: '#4f4a45', balcony: '#8e8880',
           bathF: '#8e8a85', bathW: '#cfcac2', bathC: '#3b3d45', kDoor: '#2f3b4c', kUpper: '#e8e2d8', kTop: ['#e8e4dd', 'marble'],
           black: '#232527', metal: '#b08d57', cab: '#e8e2d8', studyTop: ['#2f3b4c', 'plain'], wood: '#6b4f3a', linen: '#f4f1eb',
           sofa: '#3d4a5c', rug: '#b9ad9c', chair: '#2f3b4c', plant: '#556b5a', pot: '#2f3b4c', towel: '#e6e0d5', acc: '#b08d57', ledge: '#2f3b4c', frameWhite: '#e9e5de' },
    },
    {
      id: 'concrete', label: '차콜 인더스트리얼', region: '베를린 · 로프트',
      desc: '콘크리트 질감 벽, 다크 그레이 타일 바닥, 매트 블랙 주방과 스테인리스, 웜 우드 포인트로 차갑지 않게.',
      kelvin: 3000,
      s: { wall: ['#cfcdc8', 'concrete'], ceiling: '#bfbdb8', floor: ['#6b6a67', 'tile'], floorBed: ['#a08767', 'wood'], foyer: '#4a4947', balcony: '#7a7976',
           bathF: '#5d5c5a', bathW: '#8a8985', bathC: '#3a3a39', kDoor: '#2e2e2e', kUpper: '#3a3a3a', kTop: ['#b9bcc0', 'gloss'],
           black: '#1e1e1e', metal: '#b9bcc0', cab: '#3a3a3a', studyTop: ['#a08767', 'wood'], wood: '#8c6f52', linen: '#d9d5cf',
    ...
    },
    {
      ...
      kelvin: 2700,
      s: { wall: '#f1eadc', ceiling: '#f5f0e6', floor: ['#8b6a4e', 'wood'], foyer: '#5f574f', balcony: '#a39a8e',
           bathF: '#a49b8f', bathW: '#e6dfd2', bathC: '#efe9dd', kDoor: ['#b27f55', 'wood'], kUpper: '#f1eadc', kTop: ['#2b2724', 'plain'],
           black: '#2b2724', metal: '#c9a86a', cab: '#f1eadc', studyTop: ['#b27f55', 'wood'], wood: '#9a6d4b', linen: '#f2ece1',
           sofa: '#c7955f', rug: '#d9c6a6', chair: '#5b4636', plant: '#6b7f5a', pot: '#b27f55', towel: '#ecdfcc', acc: '#2b2724', ledge: '#b27f55', frameWhite: '#f1eadc' },
    },
    {
      ...
      s: { wall: '#e5e5e3', ceiling: '#eeeeec', floor: ['#9d9d9b', 'tile'], foyer: '#5a5a58', balcony: '#8a8a88',
           bathF: '#7f7f7d', bathW: '#cfcfcd', bathC: '#d8d8d6', kDoor: '#8c8c8a', kUpper: '#ececea', kTop: ['#f2f2f0', 'plain'],
           black: '#232323', metal: '#b9bcc0', cab: '#ececea', studyTop: ['#4a4a48', 'plain'], wood: '#8a8580', linen: '#f2f2f0',
    ...
    },
    {
      ...
      kelvin: 2700,
      s: { wall: ['#e9e3d8', 'concrete'], ceiling: '#eee9e0', floor: ['#d3cabb', 'tile'], foyer: '#a59c8e', balcony: '#c4bcae',
           bathF: '#bdb4a6', bathW: '#ddd5c8', bathC: '#e6e0d5', kDoor: '#a9a196', kUpper: '#e6e0d5', kTop: ['#cfc7b9', 'concrete'],
           black: '#3a3733', metal: '#a89a86', cab: '#e6e0d5', studyTop: ['#cfc7b9', 'concrete'], wood: '#b39c7d', linen: '#efe9df',
    ...
    },
    {
      ...
      kelvin: 3000,
      s: { wall: '#f2f1ed', ceiling: '#f5f4f1', floor: ['#8f6f52', 'wood'], foyer: '#3f3d3a', balcony: '#8a8780',
           bathF: '#4e4c49', bathW: '#5c5a56', bathC: '#2e2e2d', kDoor: '#202020', kUpper: ['#c9ad86', 'wood'], kTop: ['#202020', 'plain'],
           black: '#202020', metal: '#2b2b2b', cab: '#f2f1ed', studyTop: ['#202020', 'plain'], wood: '#8f6f52', linen: '#f2f1ed',
           sofa: '#2f2f2e', rug: '#b9ad9c', chair: '#202020', plant: '#4f6350', pot: '#202020', towel: '#e6e2da', acc: '#202020', ledge: '#202020', frameWhite: '#f2f1ed' },
    },
    {
      ...
      s: { wall: '#ede4de', ceiling: '#f3eeea', floor: ['#cdc3b4', 'wood'], foyer: '#8c8680', balcony: '#b6afa6',
           bathF: '#b8b0a8', bathW: '#e2d9d3', bathC: '#ebe4df', kDoor: '#cfc6bf', kUpper: '#efe9e4', kTop: ['#efe9e4', 'marble'],
           black: '#3a3634', metal: '#c9a48f', cab: '#efe9e4', studyTop: ['#cfc6bf', 'plain'], wood: '#b5a48f', linen: '#f3ede8',
...
function fin(v, defFinish, extra = {}) { return Array.isArray(v) ? { color: v[0], finish: v[1], ...extra } : { color: v, finish: defFinish, ...extra }; }
...
function P(s) {
  ...
  const cab = { color: s.cab, finish: 'plain', rough: 0.5 };
  return {
    ...
    'appliance': { color: s.black, finish: 'gloss' }, 'steel': { color: s.metal, finish: 'gloss', metal: 0.9, rough: 0.3 },
    ...
    'bed.frame': wood(s.wood), 'wood.desk': wood(s.wood), 'bed.linen': { color: s.linen, finish: 'fabric' },
    ...
    'sofa': { color: s.sofa, finish: 'fabric' }, 'rug': { color: s.rug, finish: 'fabric' }, 'chair': { color: s.chair, finish: 'fabric' },
    'plant': { color: s.plant, finish: 'fabric' }, 'pot': { color: s.pot, finish: 'plain' }, 'shade': { color: s.black, finish: 'plain' },
    'bath.acc': { color: s.acc, finish: 'gloss', metal: 0.5, rough: 0.35 }, 'bath.ledge': fin(s.ledge, 'plain', { rough: 0.3 }), 'towel': { color: s.towel, finish: 'fabric' },
    ...SANITARY,
  };
}
